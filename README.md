...
Bu repository, FinTechBankX DDD/EDA dönüşümünde **svc-ctr-asyncapi-catalog** servis yetkinliğinin kaynak kodunu, kontratlarını ve operasyonel guardrail'lerini içerir.
...
| Bounded Context | asyncapi_catalog |
| Wave | 4 |
...
## Kapsam
### In Scope
- asyncapi_catalog bağlamına ait uygulama kodu, testler ve otomasyon.
